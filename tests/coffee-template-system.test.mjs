...
assert.match(html, /data-page="techniques"><i data-lucide="wand-sparkles"><\/i>基础技巧/);
assert.match(html, /id="techniques"/);
...
assert.match(html, /function findCoffeeMethodRecipe\(kind = "pour"\)/);
assert.match(html, /function applyBeanParamsToMethod\(recipe, beanId, kind = "pour"\)/);
...
assert.match(html, /id="coffeeFollowStart"/);
assert.match(html, /\.generic-detail\.coffee-parameter-view \.pour-guide-head \{ display: none; \}/);
assert.match(html, /class="pour-plan-note check"/);
assert.match(html, /class="pour-plan-note caution"/);
